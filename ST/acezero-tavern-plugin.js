...
(async function () {
  ...
  const WEALTH_CLASSES = {
    poor:   { chips: 500,   blinds: [5, 10],      desc: '贫民窟' },
    normal: { chips: 2000,  blinds: [20, 40],     desc: '市民' },
    rich:   { chips: 10000, blinds: [100, 200],   desc: '富豪' },
    whale:  { chips: 50000, blinds: [500, 1000],  desc: '巨鲸/顶级局' }
  };
